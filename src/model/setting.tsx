export interface Setting {
    ...
    pay_roll_report_auto_number: boolean
    pay_roll_report_auto_format: string
    pay_roll_report_static_character: string
    pay_roll_report_auto_number_character_length: number
